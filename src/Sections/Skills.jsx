...
const Skills = () => {
  return (
    <div id='skills' className='relative text-white bg-[linear-gradient(360deg,#060824,#110932)] px-[5vw] sm:px-[4vw] lg:px-[7vw] pt-25 pb-40'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-0 sm:gap-x-6 lg:gap-x-12 w-full lg:w-11/12 m-auto'>
        {skillData.map(cat => {
          return (
            <div key={cat.title} className='border-2 border-gray-200 bg-[#17122a] rounded-lg px-3 py-5 sm:p-5 shadow-[0_0_20px_rgb(39,28,80)]'>
