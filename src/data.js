...
export const projectData = [
  {
    ...
    keyFeatures: ['Built a React-based ecommerce app with product listing, category filtering, and cart management.', 'Implemented Context API for state management and LocalStorage for data persistence.', 'Integrated React Router for seamless navigation between pages.'],
